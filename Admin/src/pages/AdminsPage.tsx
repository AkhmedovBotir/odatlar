...
export function AdminsPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      if (formMode === 'create') {
        ...
        snackbar.success('Admin muvaffaqiyatli qo\'shildi')
        ...
        snackbar.success('Admin yangilandi')
      }
      closeForm()
      fetchAdmins()
    } catch (err) {
  ...
  async function handleToggleStatus(admin: Admin) {
    ...
    try {
      ...
      snackbar.success('Admin statusi yangilandi')
      fetchAdmins()
    } catch (err) {
      snackbar.error(getApiErrorMessage(err, 'Status o\'zgartirishda xato'))
    } finally {
      setTogglingId(null)
    }
  }
  ...
  async function handleDelete() {
    ...
    try {
      ...
      setDeleteId(null)
      snackbar.success('Admin o\'chirildi')
      fetchAdmins()
    } catch (err) {
