    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[60] overflow-y-auto bg-black/55 backdrop-blur-[2px]"
          onClick={onClose}
        >
          <div className="flex min-h-full justify-center px-4 pb-[calc(5.5rem+env(safe-area-inset-bottom,0px))] pt-14 sm:items-center sm:px-6 sm:pb-10 sm:pt-10">
            <motion.div
