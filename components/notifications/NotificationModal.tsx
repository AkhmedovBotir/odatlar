      ...
      {notification && (
        ...
        >
          <motion.div
            ...
            className="max-h-[90vh] w-full max-w-md overflow-y-auto rounded-t-2xl border border-slate-600 bg-gradient-to-br from-slate-800 to-slate-900 p-5 sm:rounded-2xl"
          >
